...
export const EXISTING_RA_ERROR_MESSAGE =
  'We already have an account associated with that RA.';
export const EXISTING_EMAIL_ERROR_MESSAGE =
  'We already have an account associated with that email address.';
export const BIG_NAME_ERROR_MESSAGE =
  'Please shorten your name to 100 characters or less.';
export const WRONG_RA_SIZE_ERROR_MESSAGE =
  'RA must be exactly 8 characters long.';
...
export const ACCESS_GROUP_NOT_EXIST_ERROR_MESSAGE =
  'Access group does not exist!';
export const IMAGE_NOT_FOUND_ERROR_MESSAGE = 'No image found!';
export const WRONG_PASSWORD_SIZE_ERROR_MESSAGE =
